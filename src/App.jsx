...
function AuthenticatedApp({ variantContext, onChangeVariant, presentationMode = false }) {
  ...
  const [liveDemoState, setLiveDemoState] = useState({ matchRevealed: false, chatEnabled: false });
