...
export const store = { users: new Map(), profiles: new Map(), profileCompletedAt: new Map(), preferences: new Map(), consents: new Map(), verifications: new Map(), funnelEvents: [], matches: new Map(), chats: new Map(), chatMetrics: new Map(), presence: new Map(), payments: new Map(), contracts: new Map(), checkins: new Map(), agreements: new Map(), tickets: new Map(), feedback: new Map(), patternAggregates: new Map(), rules: DEFAULT_RULES.map((rule) => ({ ...rule })), notifications: [], liveDemo: { matchRevealed: false, chatEnabled: false, bestCoupleRevealed: false, revealedAt: null, chatEnabledAt: null, bestCouple: null, careReportDemoStarted: false, careReportRevealed: false, careReportStartedAt: null, careReportRevealedAt: null, careReport: null, careReportReceiver: 'idle', careReportReceiverError: null } };
